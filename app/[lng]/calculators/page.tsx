        ...
        axios.get(url)
            .then((response) => {
                if (recommendedCharacteristics.length>0){
                    ...
                    console.log("Response filtered articles:", filteredCalculators);
                        ...
                        <div className="w-full grid grid-cols-1 lg:grid-cols-5 gap-2 p-8">
                            <div className="w-full lg:col-span-4 grid grid-cols-1 lg:grid-cols-3 gap-2">
                                <div className="w-full ">
                                    <a className="w-full h-52" href={`/calculator/${calculator.ID}`}>
                                        {calculator.image && (
                                            <Image
                                ...
                                <div className="w-full col-span-2 grid grid-cols-1 gap-1 lg:gap-2 p-2 lg:p-10">
                                    <p className="w-full text-center lg:text-left text-2xl font-bold">{calculator.title}</p>  
                                    <p className="w-full text-center lg:text-left text-lg">{calculator.subtitle}</p>   
                            ...
                            <div className='w-full flex flex-col items-center justify-center text-center'>
                                <h1 className='text-5xl text-center'>{calculator.avg_rating.toFixed(1)}</h1>
                                <Rating2 name="half-rating" value={calculator.avg_rating} precision={0.5} readOnly />
                            </div>             
                        </div>
                        <hr key={`${calculator.id}-hr`}  /> 
                    </div>
                ))
            ) : (
