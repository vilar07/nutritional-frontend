...
export default function createArticle({ params: { lng } }: PropsType) {
    ...
    async function createArticle() {
        if (!title || !subtitle || !description || !images || !time_of_day_relevance || !season_relevance) {
        ...
        try {
            axios.post('http://localhost:4000/objects/article', data)
            .then(response => {
                console.log(response);
                if (associations.length > 0){
                    axios.post(`http://localhost:4000/objects/associate/article/${title}`, associations)
                    .then(response => {
                        console.log(response);
            ...
            <div className="w-full md:w-4/5 flex flex-col mt-8">
                ...
                <div className="w-full grid grid-cols-1 gap-2 p-4">
                    <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-2">
                        <div className="w-full grid grid-cols-1 gap-2 border-2 rounded-xl bg-white">
                            <div className="w-full text-center p-4">
                                <h1 className="mt-2 mb-2 font-bold text-xl text-green2">Create Article</h1>
                                <hr className="mb-4" />
                        ...
                        <div className="w-full grid grid-cols-1 gap-2 border-2 rounded-xl bg-white whitespace-wrap">
                            <div className="w-full text-center p-4 ">
                                ...
                                <div className="w-full grid grid-cols-1 gap-4 px-16 mt-24">
                                    <div className="w-full flex items-center justify-center text-left  p-4 border-2 rounded-xl shadow-lg hover:scale-105">
                    ...
                    <div className="w-full text-center">
                        <Button onClick={createArticle} label="Create" className='p-3 bg-gray-500 text-white hover:bg-white hover:text-gray-500 ' text raised/> 
                    </div>
                </div>
            </div>
        </div>
